...
<div class="row">
    ...
    <div class="col mr-sm-3">
        <h1 class="">Jobs <small class="text-muted">(Manage)</small><button type="button" class="btn btn-info pl- pr-3 float-right btn-lg print-button prevent-print">Print</button></h1>
