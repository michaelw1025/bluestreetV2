...
<div class="row">
    ...
    <div class="col mr-sm-3">
        <h1 class="">Medical Plan<button type="button" class="btn btn-info pl- pr-3 float-right btn-lg print-button prevent-print">Print</button></h1>
        ...
        {{ csrf_field() }}
            <div class="form-group row">
                ...
                <div class="col-sm-10 col-md-8 col-lg-6">
                    <input type="text" class="form-control" name="description" required value="{{$medicalPlan['description']}}">
            ...
            <div class="form-group row prevent-print">
                <div class="col-sm-10 col-md-8 col-lg-6">
                    ...
                    <button type="submit" class="btn btn-danger delete-item" formaction="{{url('hr.medical-plans/'.$medicalPlan['id'].'/delete')}}" name="medical plan">Delete Medical Plan</button>
                </div>
            </div>
        </form>
            <!-- </form> -->
