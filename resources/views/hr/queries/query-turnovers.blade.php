...
<div class="row">
    ...
    <div class="col mr-sm-3">
        <h1 class="">Turnover<button type="button" class="btn btn-info pl- pr-3 float-right btn-lg print-button prevent-print">Print</button></h1>
        <hr class="border-info"/>
        @include('layouts.session-messages')
        <form method="get" action="{{url('hr.query-turnovers')}}">
        {{ csrf_field() }}
        <div class="form-row align-items-center">
            ...
            <button type="submit" class="btn btn-outline-success prevent-print" name="submit_turnover_search" value="search">Search</button>
        </div>
        </form>
